...
class DashboardCardRegistry
{
    ...
    {
        return [
            'newscan'        => ['label_key' => 'ui.dashboard.newscan.title', 'default_zone' => 'main', 'required' => false],
            ...
            'recent_callers' => ['label_key' => 'ui.recent_callers.title', 'default_zone' => 'sidebar', 'required' => false],
