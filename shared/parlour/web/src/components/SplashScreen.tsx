...
export function SplashScreen() {
  preload('/webdoors/parlour/assets/parlour-logo-splash.svg', { as: 'image' }); // L33TEST: literal basePath prefix, see next.config.ts
  ...
  return (
    ...
    >
      ...
      <img className={s.logo} src="/webdoors/parlour/assets/parlour-logo-splash.svg" alt="" draggable={false} />
