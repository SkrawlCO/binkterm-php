  ...
  return (
    <main className="flex min-h-dvh flex-col items-center justify-center gap-5 px-6 text-center shortscape:gap-2">
      ...
      <h1 aria-label="parlour" className="-my-8 shortscape:-my-5">
        ...
        <img
          // L33TEST: literal `basePath` prefix (see ../../next.config.ts) — a
          // plain <img src> is not basePath-rewritten by Next the way
          // next/image or <Link> are.
          src="/webdoors/parlour/assets/parlour-logo-home.svg"
          alt=""
          draggable={false}
