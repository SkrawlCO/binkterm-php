import { RECENT_ANSWER_WINDOW } from './constants';
import { pickRandom, type RandomSource } from './random';
import type { GameState, WordLength } from './types';
 ...
 */
export function createGame({ id, wordLength, answer }: CreateGameOptions): GameState {
  return {
    id,
    wordLength,
