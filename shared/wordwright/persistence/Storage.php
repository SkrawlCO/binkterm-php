...
final class Storage
{
    ...
    {
        $this->store = new LeasedWebDoorStorage($db, $caller, 'wordwright');
    }
    public function request(array $input): array
    {
        ...
        // Opaque caller-owned snapshot, not a score/anti-cheat authority. WordwrightSession.restore
