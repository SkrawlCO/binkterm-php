...
export function cloneCandidates(s) {
    return {
...
export function place(s, cell, value) {
    s.grid[cell] = value;
    s.cand[cell] = 0;
    s.empty--;
    const bit = 1 << value;
...
export function eliminate(s, cell, bits, digitsOf, removed) {
